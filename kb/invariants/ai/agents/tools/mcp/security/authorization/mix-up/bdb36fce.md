...
**VERSION ATTRIBUTION, CHECKED RATHER THAN ASSUMED.** This is genuinely new in `2026-07-28`. Grepping every one of the 38 `.mdx` files under both `docs/specification/2025-11-25/` and `docs/docs/2025-11-25/` for `9207` and `authorization_response_iss_parameter_supported` returns zero hits.
